    ...
    update: publicProcedure
      .input(z.object({
        ...
        data: z.object({
          ...
          propertyType: z.union([z.enum(["apartment", "house", "commercial", "land", "parking", "other"]), z.literal(""), z.null()]).optional().transform(val => val === "" ? null : val),
          subType: z.string().optional().nullable(),
          marketingType: z.union([z.enum(["sale", "rent", "lease"]), z.literal(""), z.null()]).optional().transform(val => val === "" ? null : val),
          status: z.union([z.enum(["acquisition", "preparation", "marketing", "reserved", "notary", "sold", "completed"]), z.literal(""), z.null()]).optional().transform(val => val === "" ? null : val),
          ...
          hideStreetOnPortals: z.boolean().optional().nullable(),
          districtCourt: z.string().optional().nullable(),
          landRegisterSheet: z.string().optional().nullable(),
          landRegisterOf: z.string().optional().nullable(),
          cadastralDistrict: z.string().optional().nullable(),
          ...
          hasGuestToilet: z.boolean().optional().nullable(),
          hasBuiltInKitchen: z.boolean().optional().nullable(),
          hasBalcony: z.boolean().optional().nullable(),
          hasTerrace: z.boolean().optional().nullable(),
          hasLoggia: z.boolean().optional().nullable(),
          hasGarden: z.boolean().optional().nullable(),
          isMonument: z.boolean().optional().nullable(),
          suitableAsHoliday: z.boolean().optional().nullable(),
          hasStorageRoom: z.boolean().optional().nullable(),
          hasFireplace: z.boolean().optional().nullable(),
          hasPool: z.boolean().optional().nullable(),
          hasSauna: z.boolean().optional().nullable(),
          hasAlarm: z.boolean().optional().nullable(),
          ...
          energyCertificateValidUntil: z.string().optional().nullable(),
          energyCertificateType: z.string().optional().nullable(),
          energyClass: z.string().optional().nullable(),
          energyConsumption: z.number().optional().nullable(),
          energyConsumptionElectricity: z.number().optional().nullable(),
          energyConsumptionHeat: z.number().optional().nullable(),
          co2Emissions: z.number().optional().nullable(),
          includesWarmWater: z.boolean().optional().nullable(),
          heatingType: z.string().optional().nullable(),
          mainEnergySource: z.string().optional().nullable(),
          buildingYearUnknown: z.boolean().optional().nullable(),
          ...
          notaryId: z.number().optional().nullable(),
          propertyManagementId: z.number().optional().nullable(),
          tenantId: z.number().optional().nullable(),
          assignmentType: z.string().optional().nullable(),
          assignmentDuration: z.string().optional().nullable(),
          assignmentFrom: z.union([z.string(), z.date()]).optional().nullable(),
          assignmentTo: z.union([z.string(), z.date()]).optional().nullable(),
          internalCommissionPercent: z.string().optional().nullable(),
          internalCommissionType: z.union([z.enum(["percent", "euro"]), z.literal(""), z.null()]).optional().transform(val => val === "" ? null : val),
          externalCommissionInternalPercent: z.string().optional().nullable(),
          externalCommissionInternalType: z.union([z.enum(["percent", "euro"]), z.literal(""), z.null()]).optional().transform(val => val === "" ? null : val),
          totalCommission: z.number().optional().nullable(),
          externalCommissionForExpose: z.string().optional().nullable(),
          commissionNote: z.string().optional().nullable(),
          walkingTimeToPublicTransport: z.number().optional().nullable(),
          distanceToPublicTransport: z.number().optional().nullable(),
          drivingTimeToHighway: z.number().optional().nullable(),
          distanceToHighway: z.number().optional().nullable(),
          drivingTimeToMainStation: z.number().optional().nullable(),
          distanceToMainStation: z.number().optional().nullable(),
          drivingTimeToAirport: z.number().optional().nullable(),
          distanceToAirport: z.number().optional().nullable(),
          landingPageSlug: z.string().optional().nullable(),
          landingPagePublished: z.boolean().optional().nullable(),
          headline: z.string().optional().nullable(),
          descriptionHighlights: z.string().optional().nullable(),
          descriptionLocation: z.string().optional().nullable(),
          descriptionFazit: z.string().optional().nullable(),
          descriptionCTA: z.string().optional().nullable(),
          linkedContactIds: z.string().optional().nullable(),
          autoSendToPortals: z.boolean().optional().nullable(),
          buyerCommission: z.string().optional().nullable(),
          courtCity: z.string().optional().nullable(),
          courtName: z.string().optional().nullable(),
          descriptionObject: z.string().optional().nullable(),
          developmentStatus: z.union([z.enum(["fully_developed", "partially_developed", "undeveloped", "raw_building_land"]), z.literal(""), z.null()]).optional().transform(val => val === "" ? null : val),
          floors: z.number().optional().nullable(),
          furnishingQuality: z.union([z.enum(["simple", "normal", "upscale", "luxurious"]), z.literal(""), z.null()]).optional().transform(val => val === "" ? null : val),
          hasGarage: z.boolean().optional().nullable(),
          internalNotes: z.string().optional().nullable(),
          isArchived: z.boolean().optional().nullable(),
          landRegisterNumber: z.string().optional().nullable(),
